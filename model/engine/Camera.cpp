...
std::vector<std::pair<Point3D, Point3D>> Camera::render(const Matrix4d &prescaling,const std::vector<Polyline3D> &polylines) const
{
...
void Camera::updateProjection()
{
    ...
    Matrix4d projection {{2/width_ * zForward_,0,0,0},{0,2/height_ * zForward_, 0,0},{0,0,zBack_/(zBack_-zForward_),-zForward_*zBack_/(zBack_-zForward_)},{0,0,1,0}};
